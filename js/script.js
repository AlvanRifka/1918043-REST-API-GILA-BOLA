const ApiKey = "b042919dd2aa45b28837b9a6bdbdc53e";
...
function showTeamInfo(id){
    let detailtim = baseUrl + "teams/" + id;
    
    fetch(detailtim, fetchHeader)
        .then(response => response.json())
        .then(resJson => {
        ...
        title.innerHTML = "Info Resmi Klub "+ shortName ;
        contents.innerHTML = `
        <div class="card">
        <table class="stripped responsive-table">
            <tr >
                <td rowspan="8" width="10px">
                       <img src="${crestUrl}" width=200px height=200px>
                </td>
            </tr>   
            <tr> 
                <td>Nama</td>
            ...
            <table class="stripped responsive-table">
                <tr>
                    <th>Nama Kompetisi yang diikuti :</th>
                </tr>
                <tbody>
                    ${activeCompetitions}
                </tbody>
